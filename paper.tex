...
Das Fahrzeug \textbf{e} befindet sich in direkter Nähe zum \textbf{w} und kann somit diese Internetverbindung transient zur Verfügung stellen.
...
Für die Kommunikation innerhalb von \textit{Clustern} auf \textit{content-based routing} gesetzt, sodass Nachrichten mittels Überprüfung des Inhalts an die Fahrzeuge weitergeleitet werden kann, die sich dafür interessieren, ohne zuvor explizit die Empfänger festzulegen\cite{conti2013mobile}.
